            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container box_1620">
                    ...
                    <a class="navbar-brand logo_h" href={{route('home')}}><img
                                src={{asset('vendor/sensive/img/logo.png')}} alt=""></a>
                    ...
                    <!-- Collect the nav links, components, and other content for toggling -->
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav justify-content-center">
                            <li class="nav-item active"><a class="nav-link" href={{url("/")}}>Página Inicial</a></li>
                            <li class="nav-item submenu dropdown">
                                <a href="{{ action('Site\ModalityController@index') }}" class="nav-link dropdown-toggle"
                                   data-toggle="dropdown" role="button"
                                   aria-haspopup="true"
                                   aria-expanded="false">Modalidades</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ action('Site\ModalityController@show','volley') }}">Volley</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ action('Site\ModalityController@show','handball') }}">Handball</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ action('Site\ModalityController@show','futsal') }}">Futsal</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ action('Site\ModalityController@show','basquete') }}">Basquete</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ action('Site\ModalityController@show','xadrez') }}">Xadrez</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ action('Site\ModalityController@show','tenis-de-mesa') }}">Tênis
                                            de mesa</a></li>
                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ action('Site\ModalityController@show','futebol') }}">Futebol</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="{{route("punctuations")}}">Placar</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{route("locals.index")}}">Locais</a></li>
                            @guest
                                <li class="nav-item">
